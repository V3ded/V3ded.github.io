...
Now unlike the OSCP and some other training courses, you do **not** receive a PDF. However, lab time and access to Canvas or Slack doesn't expire. You will have lifetime access to the course and its subsequent upgrades without any additional payments.
